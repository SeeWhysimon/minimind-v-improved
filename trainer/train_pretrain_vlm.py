...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="/data/minimind-v/out", help="模型保存目录")
    ...
    parser.add_argument("--data_path", type=str, default="/data/minimind-v/sft_i2t.parquet", help="训练数据路径")

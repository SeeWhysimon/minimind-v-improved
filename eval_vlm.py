...
def init_model(args):
    ...
    if 'model' in args.load_from:
        ...
        model = MiniMindVLM(
            ...
            vision_model_path='/data/minimind-v/model/siglip2-base-p32-256-ve'
        )
...
def main():
    ...
    parser.add_argument('--load_from', default='/workspace/minimind-v/model', type=str, help="模型加载路径（model=原生torch权重，其他路径=transformers格式）")
    parser.add_argument('--save_dir', default='/data/minimind-v/out', type=str, help="模型权重目录")
